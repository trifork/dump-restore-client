 ...
 *
 *  $HeadURL: https://svn.softwareborsen.dk/dump-restore-client/tags/release-1.0.0/dump-restore-client/src/test/java/dk/nsi/dump_restore_client/TestCprPair.java $
 *  $Id: TestCprPair.java 10919 2013-03-22 07:42:57Z ChristianGasser $
 * /
 */
...
public class TestCprPair {
    ...
    public void testFromFile() throws IOException {
        ...
        assertEquals(cprPairs.get(2).getSourceCpr(), "1234567890");
        assertEquals(cprPairs.get(2).getTargetCpr(), "2345678901");
    }
