 ...
 *
 *  $HeadURL: https://svn.softwareborsen.dk/dump-restore-client/tags/release-1.0.2/dump-restore-client/src/main/java/dk/nsi/dump_restore_client/DumpRestoreClient.java $
 *  $Id: DumpRestoreClient.java 10985 2013-04-02 20:22:06Z ChristianGasser $
 * /
 */
...
public class DumpRestoreClient {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                StaticConfig staticConfig = StaticConfigImpl.loadFromStream(openConfiguration());
