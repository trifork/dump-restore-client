 ...
 *
 *  $HeadURL: https://svn.softwareborsen.dk/dump-restore-client/tags/release-1.0.2/dump-restore-client/src/main/java/dk/nsi/dump_restore_client/NonFatalException.java $
 *  $Id: NonFatalException.java 10985 2013-04-02 20:22:06Z ChristianGasser $
 * /
 */
...
public class NonFatalException extends RuntimeException {
    ...
    public NonFatalException(String message, Throwable e) {
        super(message, e);
    }
