 ...
 *
 *  $HeadURL: https://svn.softwareborsen.dk/dump-restore-client/tags/release-1.0.5/dump-restore-client/src/main/java/dk/nsi/dump_restore_client/DirectoryDumpRestore.java $
 *  $Id: DirectoryDumpRestore.java 34625 2017-12-13 16:09:52Z ChristianGasser $
 * /
 */
...
public class DirectoryDumpRestore implements DumpRestoreDomain {
    ...
    public void restore(String service, String cpr, String base64Data, String ignoredDate) {
        File file = getFile(service, cpr);
        try {
            file.createNewFile();
