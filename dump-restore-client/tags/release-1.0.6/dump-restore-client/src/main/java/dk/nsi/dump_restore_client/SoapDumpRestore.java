 ...
 *
 *  $HeadURL: https://svn.softwareborsen.dk/dump-restore-client/tags/release-1.0.6/dump-restore-client/src/main/java/dk/nsi/dump_restore_client/SoapDumpRestore.java $
 *  $Id: SoapDumpRestore.java 34625 2017-12-13 16:09:52Z ChristianGasser $
 * /
 */
...
public class SoapDumpRestore implements DumpRestoreDomain {
    ...
    private static final String RESTOREWITHDATE_REQUEST_FRAGMENT =
            "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                    "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\">\n" +
                    "  <soapenv:Body>\n" +
                    "    <ssi2013:RestorePatientsRequest xmlns:ssi2013=\"http://www.ssi.dk/nsi/xml.schema/2013/01/01\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">\n" +
                    ...
                    "        </ssi2013:Identifier>\n" +
                    "        <ssi2013:DumpData>%s</ssi2013:DumpData>\n" +
                    "        <ssi2013:RestoreAtDate>%s</ssi2013:RestoreAtDate>\n" +
                    "      </ssi2013:Dump>\n" +
                    "    </ssi2013:RestorePatientsRequest>\n" +
                    "  </soapenv:Body>\n" +
                    "</soapenv:Envelope>";
    ...
    public void restore(String service, String cpr, String base64Data, String date) {
        URL endpoint = staticConfig.getEndpoint(environment, service);
        String response = callService(endpoint, buildRestoreRequest(cpr, base64Data, date), RESTORE_SOAP_ACTION);
    ...
    String buildRestoreRequest(String cpr, String base64Data, String date) {
        if (date != null) {
            return String.format(RESTOREWITHDATE_REQUEST_FRAGMENT, cpr, base64Data, date);
        } else {
